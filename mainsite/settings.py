...
SECRET_KEY = 'django-insecure-=1b#rp&o8&e(5!d6^#tg9@++qb$-@s(jy#mnu3uyz2gr(k9l9&'
...
EMAIL_HOST_USER = 'xtexam@126.com'  # 发送邮件的邮箱地址
EMAIL_HOST_PASSWORD = 'OBXZTEYQZNDGAOPS'  # 发送邮件的邮箱密码(这里使用的是授权码)